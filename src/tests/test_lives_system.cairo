...
mod tests {
    ...
    use crate::models::{m_LivesConfig, m_PlayerLives};

    fn namespace_def() -> NamespaceDef {
        let ndef = NamespaceDef {
            namespace: "jokers_of_neon_profile",
            resources: [
                TestResource::Model(crate::models::m_PlayerLives::TEST_CLASS_HASH),
                TestResource::Model(crate::models::m_LivesConfig::TEST_CLASS_HASH),
            ]
                .span(),
        };
